...
function (_Base) {
  ...
  function Update() {
    ...
    _defineProperty(_assertThisInitialized(_this), "validateRules", ['roomId', 'playerId']);
  ...
  _createClass(Update, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee(_ref) {
        var roomId, playerId, user, game;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                roomId = _ref.roomId, playerId = _ref.playerId;
              ...
              case 5:
                ...
                game.playerIds = game.playerIds.filter(function (id) {
                  return id !== user.playerId;
                });
                game.playerNames = game.playerNames.filter(function (name) {
              ...
              case 13:
                _socket["default"].removePlayerFromRoom(user.socketId, game.name);
